...
*"sysya" is me, "sysya" is you.* It's a name that represents the perpetual student, the one who never stops learning, listening, recording, and growing.
...
- **IK Multimedia ILoud MTM** (current reference monitors)
- **Radio Shack headphones** (a reminder that good sound isn't always expensive)

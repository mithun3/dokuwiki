...
echo "   → Visit: https://github.com/mithun3/dokuwiki/settings/secrets/actions"
...
echo "   → Visit: https://github.com/mithun3/dokuwiki/settings/actions/permissions"
...
echo "   → https://github.com/mithun3/dokuwiki/settings/secrets/actions"
echo ""
echo "3. Configure GitHub Actions Permissions"
echo "   → https://github.com/mithun3/dokuwiki/settings/actions/permissions"
echo ""
echo "4. Test with feature branch deployment"
echo "   → See Check 4 above for commands"
echo ""
echo "5. Monitor in GitHub Actions tab"
echo "   → https://github.com/mithun3/dokuwiki/actions"
echo ""
